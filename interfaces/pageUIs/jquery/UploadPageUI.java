...
public class UploadPageUI {
	...
	public static final String UPLOADED_SUCCESS_MASSAGE = "xpath=//div[contains(@class,'mainUploadSuccess')]//div[text()='%s']";
	public static final String UPLOADED_SUCCESS_LINK = "xpath=//div[@class='col-6 text-center']/a[@class='ajaxLink']";
