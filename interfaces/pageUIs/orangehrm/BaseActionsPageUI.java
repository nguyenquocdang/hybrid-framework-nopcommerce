...
public class BaseActionsPageUI {
	...
	public static final String DYNAMIC_SUCCESS_MASSAGE = "xpath=//p[contains(@class,'oxd-text--toast-message') and text()='%s']";
	...
	public static final String DYNAMIC_RADIO_BUTTON_BY_LABEL_NAME = "xpath=//label[text()='%s']/input";
