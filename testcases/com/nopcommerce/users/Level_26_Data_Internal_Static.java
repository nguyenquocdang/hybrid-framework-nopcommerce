...
import com.nopcommerce.account.UserObjects;
...
public class Level_26_Data_Internal_Static extends BaseTest{
	...
	public void beforeClass(String browserName) {
		...
		emailAddress = getEmailAddressRandom(UserObjects.EMAIL_ADDRESS);
...
//		Assert.assertFalse(homePage.isRegisterLinkDisplayed());
	...
	public void User_02_Register_Success(Method method) {
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 01: Enter to First Name textbox with value is " + UserObjects.FIRST_NAME);
		registerPage = homePage.clickToRegisterLink();
		registerPage.enterToFirstNameTextBox(UserObjects.FIRST_NAME);
		
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 02: Enter to Last Name textbox with value is " + UserObjects.LAST_NAME);
		registerPage.enterToLastNameTextBox(UserObjects.LAST_NAME);
		...
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 04: Enter to Password textbox with value is " + UserObjects.PASSWORD);
		registerPage.enterToPasswordTextBox(UserObjects.PASSWORD);
		
		ExtentTestManager.getTest().log(Status.INFO, "Register - Step 05: Enter to ConfirmPassword textbox with value is " + UserObjects.PASSWORD);
